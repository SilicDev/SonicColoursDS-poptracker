...
sonic_colours_ds__location = {}
sonic_colours_ds__location.__index = sonic_colours_ds__location
...
function sonic_colours_ds__location.new(name)
    local self = setmetatable({}, sonic_colours_ds__location)
    if name then
...
function sonic_colours_ds__location:connect_one_way(exit, rule)
    if type(exit) == "string" then
        ...
        if existing then
            ...
            exit = sonic_colours_ds__location.new(exit)
        end
    end
    if rule == nil then
        rule = always
...
function sonic_colours_ds__location:connect_two_ways(exit, rule)
...
function sonic_colours_ds__location:connect_one_way_entrance(name, exit, rule)
    if rule == nil then
        rule = always
    end
    self.exits[#self.exits + 1] = { exit, rule }
...
function sonic_colours_ds__location:connect_two_ways_entrance(name, exit, rule)
...
-- acts as a shortcut for 2 connect_one_way_entrance-calls
function sonic_colours_ds__location:connect_two_ways_entrance_door_stuck(name, exit, rule1, rule2)
...
function sonic_colours_ds__location:connect_two_ways_stuck(exit, rule1, rule2)
...
function sonic_colours_ds__location:accessibility()
...
-- 
function sonic_colours_ds__location:discover(accessibility, keys)
...
entry_point = sonic_colours_ds__location.new("entry_point")
